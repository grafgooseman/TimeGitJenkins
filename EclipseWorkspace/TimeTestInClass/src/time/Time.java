...
//		}
	...
	public static long getTotalMilliseconds(String time)throws NumberFormatException, StringIndexOutOfBoundsException {
		
		long totalSeconds = getTotalSeconds(time);
		long milliseconds = Integer.parseInt(time.substring(9,12));
